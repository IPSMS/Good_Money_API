...
Larry = User.create(first_name: 'Larry', last_name: "BuffaloBoy", password: 'password123', password_confirmation: 'password123', username: 'TronicData')
Bobby = User.create(first_name: 'Bobby', last_name: "BuffaloBoy", password: 'password123',password_confirmation: 'password123', username: 'SlickJacket')
